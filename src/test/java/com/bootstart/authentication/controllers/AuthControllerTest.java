...
import com.bootstart.authentication.UserAuthenticationSkeletonApplication;
...
class AuthControllerTest {
    ...
    private void signupShouldFailCaseEmailAlreadyExists(String email) throws Exception {
        ...
        assertThat(parseJsonResponse(emailAlreadyExistsError, MessageResponse.class).getMessage()).isEqualTo(MAIL_EXISTS);
    }
